...
export const API_FUNCTIONS = [
  ...
  ['grid_move', 'grid_move(actor, map, dir)', 'Move an actor one cell (n/s/e/w) on a map grid using its _x/_y attrs; honors terrain passability and fires the terrain archetype’s on_leave/on_enter. Returns { ok, moved, x, y, terrain } (no room per cell).'],
...
export const API_CATEGORIES = [
  ...
  { id: 'maps', label: 'Maps & dungeons',
    names: ['apply_template', 'instantiate_map', 'get_map_template', 'grid_move', 'generate_dungeon', 'destroy_dungeon'] },
