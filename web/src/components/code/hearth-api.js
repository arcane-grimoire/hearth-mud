...
export const API_FUNCTIONS = [
  ...
  ['find_in_inventory', 'find_in_inventory(ref, needle)', 'Match an object by name among what `ref` carries or contains.'],
  ['find_player', 'find_player(name)', 'Resolve a player by name, online or off; prefers a connected one.'],
  ['find_exit', 'find_exit(room, needle)', 'Match an exit by direction or alias, the way movement does.'],
  ['responds_to', 'responds_to(ref, hook)', 'True if the object handles that hook, including via its archetype.'],
  ...
  ['trigger', 'trigger(ref, hook, data?, actor?)', 'Fire a hook on ref after this script. `data` (a table) arrives as the hook’s 4th arg; optional `actor` fires it as that object (default: the ambient actor).'],
  ...
  ['get_time', 'get_time()', 'The in-world game clock as a table (minute, hour, day, month, year, is_day, optional weekday/day_name/month_name), or nil if no clock is configured.'],
...
export const API_CATEGORIES = [
  ...
  { id: 'queries', label: 'Queries & lookup',
    names: ['find_in_room', 'find_in_inventory', 'find_player', 'find_exit',
            'responds_to', 'match_name', 'get_players_in_room', 'get_nearby',
  ...
  { id: 'scheduling', label: 'Programs & scheduling',
    names: ['set_script', 'set_lib', 'after', 'cancel_after', 'get_timers', 'trigger', 'run_command_as', 'get_tick', 'get_time', 'prompt'] },
  { id: 'maps', label: 'Maps & dungeons',
    names: ['apply_template', 'instantiate_map', 'get_map_template', 'grid_move', 'grid_can_move', 'generate_dungeon', 'destroy_dungeon'] },
